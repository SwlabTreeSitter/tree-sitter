...
# 3. 소스 루트 폴더 (haskell/LEARN)
SOURCE_DIR = "/home/hyeonjin/PL/codecompletion_benchmarks/haskell/LEARN"

# 4. 결과 저장 폴더
OUTPUT_DIR = "/home/hyeonjin/PL/benchmarks_collection/haskell/LEARN_data"
...
IGNORE_DIRS = {
    # 공통: 빌드 및 테스트, 문서
    "build", "dist", "dist-newstyle", ".stack-work", "tests", "test", "spec",
    "doc", "docs", "examples", "example", "bench", "benchmark", "benchmarks",
    # Haskell 특화
    ".cabal-sandbox", "cabal.sandbox.config", "autogen",
    # 기타
    ".git", "scripts", "data",
}
...
def main():
    ...
    for root, dirs, files in os.walk(SOURCE_DIR):
        ...
        for filename in files:
            ...
            cmd = [EXE_PATH, "haskell", LIB_PATH, full_source_path, ARG_ROW, ARG_COL, ARG_MODE]
