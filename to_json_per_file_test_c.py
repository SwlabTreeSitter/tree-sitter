# [Linux] 구조 후보 평가를 위한 TEST 컬렉션 정답지 구성 스크립트 (C 전용)
#   1) .c -> .data
#   2) .data -> .json  <-- here

# 컬렉션 파일들(.data)을 읽어
# 커서 위치별 state_id와 candidate 정보를 JSON으로 변환
# 개별 .data 파일 -> 개별 .json 파일 (reports/c11 폴더)

# 예) reports/c11/hello_world.json
#   "1,11": {
#     "state_id": 42,
#     "candidate": "identifier = expression"
#   },
