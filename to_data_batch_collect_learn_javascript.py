...
# 2. JavaScript 언어 파서 라이브러리 경로
LIB_PATH = "/home/hyeonjin/PL/tree-sitter-javascript/javascript.so"

# 3. 소스 루트 폴더 (javascript/LEARN)
SOURCE_DIR = "/home/hyeonjin/PL/codecompletion_benchmarks/javascript/LEARN"

# 4. 결과 저장 폴더
OUTPUT_DIR = "/home/hyeonjin/PL/benchmarks_collection/javascript/LEARN_data"
...
IGNORE_DIRS = {
    ...
    "build", "dist",
    # JavaScript 특화
    "node_modules", "vendor", "fixtures", "mocks", "__mocks__",
...
def main():
    ...
    for root, dirs, files in os.walk(SOURCE_DIR):
        ...
        for filename in files:
            ...
            cmd = [EXE_PATH, "javascript", LIB_PATH, full_source_path, ARG_ROW, ARG_COL, ARG_MODE]
