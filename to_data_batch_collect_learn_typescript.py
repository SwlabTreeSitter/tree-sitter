...
# 2. TypeScript 언어 파서 라이브러리 경로
LIB_PATH = "/home/hyeonjin/PL/tree-sitter-typescript/typescript/parser.so"

# 3. 소스 루트 폴더 (typescript/LEARN)
SOURCE_DIR = "/home/hyeonjin/PL/codecompletion_benchmarks/typescript/LEARN"

# 4. 결과 저장 폴더
OUTPUT_DIR = "/home/hyeonjin/PL/benchmarks_collection/typescript/LEARN_data"
...
def main():
    ...
    for root, dirs, files in os.walk(SOURCE_DIR):
        ...
        for filename in files:
            ...
            cmd = [EXE_PATH, "typescript", LIB_PATH, full_source_path, ARG_ROW, ARG_COL, ARG_MODE]
