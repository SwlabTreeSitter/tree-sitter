...
#
# [수집 규칙]
#   - python-main/ (Exercism Python Track):
#       exercises/practice/.../.meta/example.py  : practice 완성 풀이
#       exercises/concept/.../.meta/exemplar.py  : concept 완성 풀이
#       → 위 두 패턴만 수집
#   - Python-master/:
#       모든 .py 파일 수집
...
OUTPUT_DIR = "/home/hyeonjin/PL/benchmarks_collection/python/TEST_data"
...
IGNORE_DIRS = {".git", "build", "__pycache__"}

# =========================================================

def is_exercism_target(rel_path_unix: str) -> bool:
    """
    Exercism Python Track 완성 풀이 파일 판별:
      .meta/example.py  (practice 완성 풀이)
      .meta/exemplar.py (concept 완성 풀이)
    """
