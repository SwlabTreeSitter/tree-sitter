# [Linux] 구조 후보 평가를 위한 TEST 컬렉션 정답지 구성 스크립트 (Ruby 전용)
#   1) .rb -> .data
#   2) .data -> .json  <-- here

# 컬렉션 파일들(.data)을 읽어
# 커서 위치별 state_id와 candidate 정보를 JSON으로 변환
# 개별 .data 파일 -> 개별 .json 파일 (reports/ruby 폴더)
...
# =================[ 경로 설정 ]=================
INPUT_DIR  = "/home/hyeonjin/PL/benchmarks_collection/ruby/TEST_data"
OUTPUT_DIR = "/home/hyeonjin/PL/tree-sitter/reports/ruby"
# ================================================
