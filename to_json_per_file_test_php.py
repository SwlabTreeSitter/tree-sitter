# [Linux] 구조 후보 평가를 위한 TEST 컬렉션 정답지 구성 스크립트 (PHP 전용)
#   1) .php -> .data
#   2) .data -> .json  <-- here
...
# =================[ 경로 설정 ]=================
INPUT_DIR  = "/home/hyeonjin/PL/benchmarks_collection/php/TEST_data"
OUTPUT_DIR = "/home/hyeonjin/PL/tree-sitter/reports/php"
# ================================================
