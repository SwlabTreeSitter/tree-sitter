# [Linux] DB 구축 위한 LEARN 컬렉션 빈도수 통합 스크립트 (JavaScript 전용)
#   1) .js -> .data
#   2) .data -> .json  <-- here
...
# =================[ 경로 설정 ]=================
INPUT_DIR   = "/home/hyeonjin/PL/benchmarks_collection/javascript/LEARN_data"
OUTPUT_FILE = "/home/hyeonjin/PL/code-completion-extension/resources/javascript/candidates.json"
    ...
    try:
        with open(OUTPUT_FILE, 'w', encoding='utf-8') as outfile:
            ...
            for row in cursor:
                ...
                current_patterns.append({"key": pattern, "value": count})
