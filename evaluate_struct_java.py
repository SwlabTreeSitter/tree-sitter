...
class FileReporter:
    ...
    def run_java_at_position(self, target_file, byte_offset):
        cmd = [EXE_PATH, "java", LIB_PATH, target_file, "--byte", str(byte_offset), "2"]
        try:
    ...
    def evaluate_file(self, target_file):
        ...
        for loc_key, gt_data in answers.items():
            ...
            predicted_states = self.run_java_at_position(target_file, byte_offset)
