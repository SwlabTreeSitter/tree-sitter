...
#
# [수집 규칙]
#   - cpp-main/ (Exercism C++ Track):
#       exercises/practice/.../.meta/example.cpp  : practice 완성 풀이
#       exercises/practice/.../.meta/example.h    : practice 완성 헤더
#       exercises/concept/.../.meta/exemplar.cpp  : concept 완성 풀이
#       exercises/concept/.../.meta/exemplar.h    : concept 완성 헤더
#       → 위 네 패턴만 수집
#   - C-Plus-Plus-master/, tour-of-cpp-main/:
#       모든 .cpp/.h/.hpp 파일 수집
...
OUTPUT_DIR = "/home/hyeonjin/PL/benchmarks_collection/cpp/TEST_data"
...
def is_exercism_target(rel_path_unix: str) -> bool:
    """
    Exercism C++ Track 완성 풀이 파일 판별:
      .meta/example.cpp  (practice 완성 풀이)
      .meta/exemplar.cpp (concept 완성 풀이)
    """
