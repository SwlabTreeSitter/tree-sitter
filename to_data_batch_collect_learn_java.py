...
SOURCE_DIR = "/home/hyeonjin/PL/codecompletion_benchmarks/java/LEARN"
OUTPUT_DIR = "/home/hyeonjin/PL/benchmarks_collection/java/LEARN_data"
...
def main():
    ...
    for root, dirs, files in os.walk(SOURCE_DIR):
        ...
        for filename in files:
            ...
            cmd = [EXE_PATH, "java", LIB_PATH, full_source_path, ARG_ROW, ARG_COL, ARG_MODE]
