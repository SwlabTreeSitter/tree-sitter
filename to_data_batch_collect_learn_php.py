...
# 2. PHP 언어 파서 라이브러리 경로 (php/ 서브디렉토리의 php.so)
LIB_PATH = "/home/hyeonjin/PL/tree-sitter-php/php/parser.so"

# 3. 소스 루트 폴더 (php/LEARN)
SOURCE_DIR = "/home/hyeonjin/PL/codecompletion_benchmarks/php/LEARN"

# 4. 결과 저장 폴더
OUTPUT_DIR = "/home/hyeonjin/PL/benchmarks_collection/php/LEARN_data"

# 5. 수집할 확장자
TARGET_EXTENSIONS = {".php"}

# 6. 무시할 폴더명 (학습 노이즈 제거)
IGNORE_DIRS = {
    # 공통: 테스트, 문서, 빌드
    "test", "tests", "Test", "Tests", "spec",
...
# 7. 제외할 최상위 프로젝트 폴더명 (규모가 크거나 노이즈가 많은 프로젝트)
EXCLUDE_PROJECTS = {
    "symfony-8.1",    # Symfony   (https://github.com/symfony/symfony)
    "server-master",  # Nextcloud (https://github.com/nextcloud/server)
    "drupal-main",    # Drupal    (https://github.com/drupal/drupal)
    "psalm-6.x",      # Psalm     (https://github.com/vimeo/psalm)
}
...
def main():
    ...
    for root, dirs, files in os.walk(SOURCE_DIR):
        # 최상위 프로젝트 제외 (SOURCE_DIR 바로 아래 폴더만 체크)
        if root == SOURCE_DIR:
        ...
        for filename in files:
            ...
            cmd = [EXE_PATH, "php", LIB_PATH, full_source_path, ARG_ROW, ARG_COL, ARG_MODE]
