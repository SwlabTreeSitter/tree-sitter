...
#
# [수집 규칙]
#   - javascript-main/ (Exercism JavaScript Track):
#       exercises/practice/.../.meta/proof.ci.js   : practice 연습문제 완성 풀이
#       exercises/concept/.../.meta/exemplar.js    : concept 연습문제 완성 풀이
...
OUTPUT_DIR = "/home/hyeonjin/PL/benchmarks_collection/javascript/TEST_data"
...
def is_exercism_target(rel_path_unix: str) -> bool:
    """
    Exercism JavaScript Track 완성 풀이 파일 판별:
      exercises/practice/.../.meta/proof.ci.js   (practice 완성 풀이)
      exercises/concept/.../.meta/exemplar.js    (concept 완성 풀이)
    """
    parts = rel_path_unix.split("/")
    if len(parts) >= 2:
        parent_dir = parts[-2]   # .meta
        filename   = parts[-1]   # proof.ci.js / exemplar.js
