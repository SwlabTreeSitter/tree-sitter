...
#
# [수집 규칙]
#   - java-main/ (Exercism Java Track):
#       exercises/practice/.../.meta/src/reference/java/*.java  : practice 완성 풀이
#       exercises/concept/.../.meta/src/reference/java/*.java   : concept 완성 풀이
#       → /.meta/src/reference/java/ 경로 패턴을 포함하는 파일만 수집
#   - Java-master/, LearnJava-master/:
#       모든 .java 파일 수집
...
OUTPUT_DIR = "/home/hyeonjin/PL/benchmarks_collection/java/TEST_data"
...
IGNORE_DIRS = {".git", "build", "target"}

# =========================================================

def is_exercism_target(rel_path_unix: str) -> bool:
    """
    Exercism Java Track 완성 풀이 파일 판별:
      .meta/src/reference/java/*.java  (practice/concept 완성 풀이)
    """
