# [Linux] DB 구축 위한 LEARN 컬렉션 빈도수 통합 스크립트 (Java 전용)
#   1) .java -> .data
#   2) .data -> .json  <-- here
...
# =================[ 경로 설정 ]=================
INPUT_DIR   = "/home/hyeonjin/PL/benchmarks_collection/java/LEARN_data"
OUTPUT_FILE = "/home/hyeonjin/PL/code-completion-extension/resources/java/candidates.json"
