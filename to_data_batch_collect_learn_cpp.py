...
SOURCE_DIR = "/home/hyeonjin/PL/codecompletion_benchmarks/cpp/LEARN"
OUTPUT_DIR = "/home/hyeonjin/PL/benchmarks_collection/cpp/LEARN_data"

TARGET_EXTENSIONS = {".cpp", ".cc", ".cxx"}
...
IGNORE_DIRS = {
    ...
    "vendor", "extern", "external", "externals",
...
def main():
    ...
    for root, dirs, files in os.walk(SOURCE_DIR):
        ...
        for filename in files:
            ...
            cmd = [EXE_PATH, "cpp", LIB_PATH, full_source_path, ARG_ROW, ARG_COL, ARG_MODE]
